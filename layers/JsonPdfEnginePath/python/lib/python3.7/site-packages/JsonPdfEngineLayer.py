...
def browser_get():
    data = {
        "data": {
            ...
            "text": "This is special place where you can spend your time with your close people",
            "links": [
                "https://vk.com",
                "https://twitter.com",
                "https://facebook.com"
    ...
    html_conf(
        {
            "ext": ".hbs",
            "layouts_dir": "layers/JsonPdfEnginePath/layouts",
            "partials_dir": "layers/JsonPdfEnginePath/components"
        }
    )

    pdf_conf(
        {
            "path": "layers/JsonPdfEnginePath/result.pdf",
            "printBackground": True,
            "format": "A4"
        }
    )
